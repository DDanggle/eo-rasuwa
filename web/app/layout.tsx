...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    title: '621 km of river, re-imaged after the Nepal flood',
    description: 'A general Earth model, used frozen, compared 1.4 million 40 m cells and ranked six places for people to check first — with the honest limits of that ranking.',
    siteName: 'Nepal AI Twin',
      images: [{ url: '/og.jpg', width: 1200, height: 630, alt: 'Rasuwa 2026 — 621 km of river re-imaged, six places ranked for review' }],
  },
  twitter: {
