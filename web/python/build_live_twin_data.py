...
POINTS = [
    {
        ...
        "story_ko": "붕괴는 네팔 영내 랑탕 리룽에서 시작됐다. 빨간 점은 공개된 자료로 추정한 발원 지점으로, 현장에서 실측해 확정하지는 않았다. 여기서 시작된 흐름이 아래로 내려가 A와 B에 닿았다.",
    },
    {
        "id": "D",
        ...
        "story_ko": "흘러내린 토사와 돌에 물길이 막히면서 호수가 생겼다는 보고가 뒤따랐다. 공개된 위치 자료가 없어 보라색 점은 대략적인 수색 범위로 볼 수 있다.",
    },
    {
        "id": "A",
        ...
        "story_ko": "네팔과 중국 국경 지역을 사건 전후로 비교한 구역이다. 상류에서 시작된 산사태와 홍수가 기반시설에 닿은 지점으로, 이번 관측에서 피해가 가장 큰 곳으로 보인다.",
    },
    {
        "id": "B",
        ...
        "story_ko": "피해 관찰 구역 바로 옆에 있는 국경 검문소다. 사진에서 밝거나 어둡게 나온 부분을 곧바로 피해라고 읽는 대신, 사람과 시설이 얼마나 노출됐는지 가늠하는 기준점으로 삼았다.",
    },
    {
        "id": "F",
        ...
        "story_ko": "하류를 찍은 센티넬-2 사진을 사건 전후로 비교한 구역이다. 발원지부터 하천의 변화까지 하나로 이어 볼 수 있게 해준다.",
    },
    {
        "id": "G",
        ...
        "story_ko": "지도에 그린 추적선은 라수와가디에서 하천을 따라 73.7km 내려온 이 지점에서 멈춘다. 미국 지질조사국은 발원지부터 약 100km를 흘러갔다고 잠정 보고했지만, 토사가 최종적으로 어디에 쌓였는지는 아직 공개하지 않았다. 실제 흐름은 이 지점보다 더 내려갔을 가능성이 크다.",
    },
    {
        "id": "C",
