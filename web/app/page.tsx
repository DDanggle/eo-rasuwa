      ...
      <footer className="landing-foot">
        <div className="foot-cols">
          ...
          <div>
            ...
            <p>{ko ? <>이 페이지는 개인 분석 프로젝트이며 기부를 받지 않습니다. 현장 지원은 공식 채널로 — IFRC가 네팔 적십자사(NRCS)를 위해 CHF 2,500만 긴급 어필을 열었습니다: <a href="https://www.ifrc.org/emergency/nepal-flash-floods-2026" target="_blank" rel="noreferrer">IFRC 긴급 어필 ↗</a> · <a href="https://donate.redcrossredcrescent.org/ifrc/nepal-flash-floods" target="_blank" rel="noreferrer">IFRC 기부 ↗</a> · <a href="https://donation.nrcs.org/" target="_blank" rel="noreferrer">네팔 적십자사 기부 ↗</a> · <a href="https://www.unicef.org/nepal/flooding-nepal-2026-0" target="_blank" rel="noreferrer">UNICEF 네팔 홍수 대응 ↗</a> · <a href="https://www.icrc.org/en/donate" target="_blank" rel="noreferrer">ICRC 기부 ↗</a></> : <>This is a personal analysis project and accepts no donations. To support the response on the ground, use official channels — the IFRC has launched a CHF 25M Emergency Appeal for the Nepal Red Cross Society: <a href="https://www.ifrc.org/emergency/nepal-flash-floods-2026" target="_blank" rel="noreferrer">IFRC Emergency Appeal ↗</a> · <a href="https://donate.redcrossredcrescent.org/ifrc/nepal-flash-floods" target="_blank" rel="noreferrer">Donate via IFRC ↗</a> · <a href="https://donation.nrcs.org/" target="_blank" rel="noreferrer">Nepal Red Cross donation ↗</a> · <a href="https://www.unicef.org/nepal/flooding-nepal-2026-0" target="_blank" rel="noreferrer">UNICEF Nepal flood response ↗</a> · <a href="https://www.icrc.org/en/donate" target="_blank" rel="noreferrer">ICRC donation ↗</a></>}</p>
          </div>
        </div>
      </footer>
    </main>
